// Cette commande consiste à modifier / modifier la configuration de la guilde. Perm niveau 3 pour les administrateurs
// et propriétaires seulement. Utilisé pour changer les préfixes et les noms de rôles et autres.

// Notez qu'il n'y a pas de "contrôles" dans cette version de base - pas de "types" de configuration comme
// Role, String, Int, etc ... C'est simple, à prolonger avec vos mains habiles!

// Notez la ** déstructuration ** ici. au lieu de `args` nous avons:
// [action, clé, ... valeur]
// Ceci nous donne l'équivalent de soit:
// action const = args [0]; clé const = args [1]; valeur const = args.slice (2);
// OU identique à:
// const [action, clé, ... valeur] = args;
